...
## Dependency
    ...
    compile 'com.jude:ferryman-core:1.4.3'
    annotationProcessor 'com.jude:ferryman-compiler:1.4.3'
...
buildscript {
    dependencies {
        classpath 'com.jude:ferryman-modular:1.4.3'
    }
}
...
提供页面管理功能，单独一套 API .
```groovy
    compile 'com.jude:ferryman-record:1.4.3'
```
