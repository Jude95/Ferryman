...
public class Constants {
    public static final String PACKAGE_INTERNAL = "com.jude.ferryman.internal";
    public static final String PACKAGE_MAIN = "com.jude.ferryman";

    public static final String CLASS_RESULT_SUFFIX = "Result";
    public static final String CLASS_PORTER_SUFFIX = "Porter";
    public static final String CLASS_ADDRESS = "RouterMap";
    public static final String CLASS_BOAT = "Boat";
    public static final String CLASS_INJECTOR = "Injector";
    public static final String CLASS_SIPHON = "Siphon";
